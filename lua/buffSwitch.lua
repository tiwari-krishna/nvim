...
-- simple_buffer_marks.lua
-- Minimal plugin: floating window lists all listed buffers. Toggle mark with <CR>,
-- reorder with J/K. After closing, <leader>1..9 jump to Nth marked buffer.
